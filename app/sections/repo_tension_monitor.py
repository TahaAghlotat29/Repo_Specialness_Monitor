...
def render():
    ...
    # Table — Most stressed episodes
    # ---------------------------------------------------------------------
    st.subheader("Most stressed episodes")
    st.caption(
        "Periods where the €STR − DFR spread reached its most negative z-score "
        "relative to the trailing 1Y distribution."
    )
